...
module.exports = class SC {
  ...
  getUserTracks(userId) {
    ...
    return request.get(`/users/${userId}/tracks`, {
      ...
      log.info('Get user tracks success:', tracks);
  ...
  getUserTracksBatch(userIds) {
    return Promise.all(userIds.map(this.getUserTracks))
  ...
  getAudioFileUrl(url) {
    log.info('Get audio file url:', url);
    return axios.get(url, {
      ...
      log.info('Get audio file url success:', res.data.location);
